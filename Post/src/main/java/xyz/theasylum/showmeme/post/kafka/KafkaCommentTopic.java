...
@Service
public class KafkaCommentTopic {
    ...
    public void sendPostMessage(KafkaComment commentMessage){
        Message<KafkaComment> message = MessageBuilder
                .withPayload(commentMessage)
